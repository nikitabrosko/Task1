...
namespace NewYearPresentTests.SweetsTests.GummyCandiesTests
{
    ...
    public class GummyCandyTests
    {
        ...
        {
            Assert.ThrowsException<ArgumentException>(() => new TestGummyCandy(name, (decimal)price, weight),
                nameof(TestGummyCandy.Name));
        }
        ...
        {
            TestGummyCandy testChocolateBar = new TestGummyCandy(name, (decimal)price, weight);
        ...
        public void GetValidAmountOfSugar()
        {
            ...
            TestGummyCandy testChocolateBar = new TestGummyCandy(name, price, weight);

            Assert.AreEqual(3.3f, testChocolateBar.AmountOfSugar);
        }
    }
}
